...
# Set RR_DEBUG_ADAPTER to select debug adapter by command-line arguments.
# e.g.) west build -b rpi_pico -- -DRR_DEBUG_ADAPTER=raspberrypi-swd
...
if ("${RR_DEBUG_ADAPTER}" STREQUAL "")
	set(RR_DEBUG_ADAPTER "cmsis-dap")
endif()

board_runner_args(openocd --cmd-pre-init "source [find interface/${RR_DEBUG_ADAPTER}.cfg]")
